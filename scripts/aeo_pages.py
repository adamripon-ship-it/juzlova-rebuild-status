...
PAGE_FAQ = {
    "cs": {
        "kdo_jsme": [
            ("Kde přesně jste?", "Kochánov 40, 582 53, kraj Vysočina, 12 km od Havlíčkova Brodu. Ne 582 91 — to je jiný Kochánov."),
    ...
    "en": {
        ...
        "kde_nas_najdete": [
            ("Do I have to phone first?", "Yes. The workshop is not a shop with opening hours on the door. Daily 8:00–19:00 by phone, weekends included."),
        ...
        "ceny": [
            ("Do the prices apply to parcels?", "The goods prices do. A parcel adds tracked shipping, box and insurance; we quote the total first."),
        ...
        "do_eu": [
            ...
            ("Do you reply in English?", "We reply in Czech; for German and English we sometimes use a translator."),
        ],
    },
    "de": {
        "kdo_jsme": [
        ...
        "do_eu": [
            ...
            ("Antworten Sie auf Deutsch?", "Wir antworten auf Tschechisch; für Deutsch nutzen wir manchmal eine Übersetzungshilfe."),
        ],
    },
    "sk": {
        "kdo_jsme": [
        ...
        "do_eu": [
            ...
            ("Kam posielate najčastejšie?", "Na Slovensko, do Nemecka, Rakúska a Poľska. Inam v EÚ dopravu nacíníme."),
            ("Odpoviete mi po slovensky?", "Odpovedáme po česky — rozumieme si."),
        ],
    },
}
...
def _build_pages(lang):
    ...
    first = {
        "objednavka_cesko": _page(
            t("Objednávka knedlíků v prášku po celé ČR — bez e-shopu | Jůzlová",
              "Order across Czechia — Jůzlová Kochánov",
              "Bestellung in Tschechien — Jůzlová Kochánov",
              "Objednávka po Česku — Jůzlová Kochánov"),
            t("Objednáte telefonem, e-mailem nebo formulářem. Vyzvednutí Kochánov a Humpolec zdarma, rozvoz po Vysočině, balík kamkoli po Česku. Ceny jako v dílně, doprava zvlášť.",
            ...
            t("E-shop nemáme a nechybí nám. Řeknete, co a kolik chcete a kde jste. Zbytek je náš.",
