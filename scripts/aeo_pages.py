...
def _build_pages(lang):
    ...
    first = {
        "objednavka_cesko": _page(
            ...
            t("Objednáte telefonem, e-mailem nebo formulářem. Vyzvednutí v Kochánově a Humpolci zdarma, rozvoz po Vysočině, balík kamkoli po Česku. Doprava zvlášť.",
              "Jůzlová supplies mixes across Czechia. Order by phone, e-mail or the form; free pick-up in Kochánov and Humpolec. Workshop prices apply; shipping is extra.",
              "Jůzlová liefert Mischungen in ganz Tschechien. Bestellung telefonisch, per E-Mail oder Formular; Abholung in Kochánov und Humpolec kostenlos. Lieferung extra.",
              "Jůzlová posiela zmesi po celom Česku. Objednávka telefónom, e-mailom alebo formulárom; odber v Kochánove a Humpolci zadarmo. Doprava zvlášť."),
            ...
            [
                ("p", t(
                    "Jůzlová vyrábí v Kochánově na Vysočině a zásobuje domácnosti v Čechách i na Moravě. Objednáte telefonem +420 728 466 141 nebo +420 607 629 931, e-mailem juzlj@seznam.cz nebo formulářem. Telefon bereme denně 8:00–19:00.",
                    "Jůzlová makes its mixes in Kochánov in the Vysočina Region and supplies households across Bohemia and Moravia. Order by phone on +420 728 466 141 or +420 607 629 931, by e-mail at juzlj@seznam.cz, or through the form. We take calls daily 8:00–19:00.",
                    "Jůzlová stellt die Mischungen in Kochánov in der Vysočina her und beliefert Haushalte in Böhmen und Mähren. Bestellung unter +420 728 466 141 oder +420 607 629 931, per E-Mail an juzlj@seznam.cz oder über das Formular. Telefonisch täglich 8:00–19:00 Uhr.",
                    "Jůzlová vyrába v Kochánove na Vysočine a zásobuje domácnosti v Čechách aj na Morave. Objednáte telefónom +420 728 466 141 alebo +420 607 629 931, e-mailom juzlj@seznam.cz alebo formulárom. Telefón berieme denne 8:00–19:00.",
                )),
