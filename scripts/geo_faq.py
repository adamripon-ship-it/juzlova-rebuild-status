    ...
    "en": [
        ("Ordering and pick-up", [
            ...
            ("Do I pay in advance or on collection?",
             "For pick-up and delivery you pay on hand-over. For parcels and EU shipments we send the total first and ship once you approve it."),
        ]),
        ("Delivery", [
            ...
            ("Do you send parcels across Czechia?",
             "Yes. We quote shipping in advance by weight and destination; you may also use your own courier."),
            ("Do you ship abroad?",
    ...
    "sk": [
        ...
        ("Doprava", [
            ...
            ("Posielate balíky na Slovensko?",
             "Áno. Dopravu, krabicu, poistenie a bublinkovú fóliu naceníme vopred; sumu vidíte pred odoslaním."),
